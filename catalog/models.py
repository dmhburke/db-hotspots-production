...
class CleanReviewModel(models.Model):
    ...
    rating = models.DecimalField(max_digits=3, decimal_places=2, blank=True, null=True)
    # START Perfect_for criteria
    pf_breakfast = models.BooleanField("pf_breakfast", default=False)
    pf_quick_lunch = models.BooleanField("pf_quick_lunch", default=False)
    pf_last_min_dinner = models.BooleanField("pf_last_min_dinner", default=False)
    pf_impressing_guests = models.BooleanField("pf_impressing guests", default=False)
    pf_date_night = models.BooleanField("pf_date_night", default=False)
    pf_big_group = models.BooleanField("pf_big_group", default=False)
    pf_peace_quiet = models.BooleanField("pf_peace_quiet", default=False)
    pf_living_large = models.BooleanField("pf_living_large", default=False)
    pf_sunny_days = models.BooleanField("pf_sunny_days", default=False)
    # END Perfect_for criteria
    notes = models.TextField(blank=True, null=True)
    city = models.CharField(max_length=30,blank=True, null=True)
    country = models.CharField(max_length=30,blank=True, null=True)
